...
# Interface principal
def main():
    """Interface principal do Sistema Santo Graal"""
    ...
    with tab1:
        ...
        with col1:
            st.markdown("""
            ### 🎯 O que é o Sistema Santo Graal?
            
            O **Sistema Santo Graal da IA** é uma implementação revolucionária que combina:
        ...
        with col2:
            ...
            with col2_1:
                st.metric("🖼️ Imagens Processadas", "4", "100%")
        ...
        architecture_data = {
            ...
            "Status": ["✅ Ativo", "✅ Ativo", "⚠️ API Necessária", "✅ Ativo"],
            "Função": [
    ...
    with tab2:
        st.header("🖼️ Análise de Imagens")
                            ...
                            try:
                                ...
                                if 'intuition_analysis' in result and 'yolo_analysis' in result['intuition_analysis']:
                                    ...
                                    if yolo_data['detections']:
                                        ...
                                        st.warning("⚠️ Nenhuma detecção encontrada")
                                ...
                                if 'revolutionary_action' in result:
                                    ...
                                    if action == 'NONE':
                                        ...
                                        st.warning(f"⚠️ Ação especial necessária: {action}")
    ...
    with tab3:
        ...
        scenario_tabs = st.tabs(["🎯 Cenário 1", "⚠️ Cenário 2", "🔄 Cenário 3"])
        ...
        with scenario_tabs[1]:
            st.markdown("""
            **⚠️ Cenário 2: YOLO Falha, Keras Tem Intuição**
    ...
    with tab5:
        ...
        st.markdown("""
        ### 🧠 Demonstração do Sistema Santo Graal
                ...
                with st.spinner("Executando simulação..."):
                    ...
                    if yolo_confidence < 0.5 and keras_confidence > 0.3:
                        ...
                        if api_response == "Sim":
                            ...
                            st.warning("⚠️ REVISÃO HUMANA NECESSÁRIA!")
        ...
        # Fluxo do sistema
        st.markdown("### 🔄 Fluxo do Sistema Santo Graal")
